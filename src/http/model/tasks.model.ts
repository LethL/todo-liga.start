...
export type GetAllTasksRequest = paths['/tasks']['get']['parameters']['query'];
export type GetAllTasksResponse = paths['/tasks']['get']['responses']['200']['content']['application/json'];

export type UpdateTaskRequest = paths['/tasks/{taskId}']['patch']['responses']['200']['content']['application/json'];
export type UpdateTaskResponse = paths['/tasks/{taskId}']['patch']['responses']['200']['content']['application/json'];

export type PostTaskRequest = paths['/tasks']['post']['responses']['200']['content']['application/json'];
